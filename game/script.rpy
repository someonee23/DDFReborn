...
define d = Character("Джо", color='#ffffff')
define du = Character("Дункан", color='#ffffff')
define er = Character("Эрик", color='#ffffff')
define g = Character("Галтон", color='#ffffff')
...
label start:
    ...
    scene bg vwf gym point with dissolve
    pause 1
    ...
    ##computer scene 1
    r 'Здарова, братан, слыхал, что ты хочешь открыть своё подземелье. У меня есть несколько человек, готовы быть рабами. Нужны?'
    ...
    ##dungeon scene 3 
    v 'Но однажды двое рабов сбежали. Их звали Эрик Дайклс и Дункан Пилс. Я их быстро нашёл и вернул назад.'
    v 'Я решил допросить их...'
    Character("Дункан", color='#ffffff') 'Сэр, сейчас мы всё объясним!'
    v 'Почему вы сбежали?'
    Character("Дункан", color='#ffffff') 'Мы хотели уйти к девушкам.'
    v 'Чёртовы рабы! Зачем? У вас был Мастер, другие рабы и подземелье. Зачем вам девушки?!'
    Character("Дункан", color='#ffffff') 'Прости нас, Мастер.'
...
label forgive:
    ...
    ##suction scene 1
    v 'Я решил наказать одного раба за то, что он не выполняет приказы Мастера.'
    v 'Для этого мы решили попробовать "сакшен"'
    ##suction scene 2
    v 'Мы погрузили раба в эту штуку.'
    v 'Я крикнул "САКШЕН!", и процесс начался.'
    ##suction scene 3
    v 'В этом процессе мне помогал мой заместитель - Джо Кексон.'
    ##suction scene 4
    v 'Во время процесса издавались непонятные звуки.'
    v 'Я начал облизывать тело раба. Оно было накаченное.'
    ##suction scene 5
    v 'Процесс завершился, и мы ушли ебаться в другую комнату.'
    scene bg van closeup
    with dissolve
    v 'Спустя какое-то время я увидел, что Эрик дрочит в неположенное время. Я решил наказать его в другой день...'
    ##slaves scene 1
    v 'Я построил их и начал отчитывать.'
    v 'Кто из вас дрочил вчера??'
    d 'Сэр, никто вчера не дрочил.'
    v 'Чётровы рабы, я ещё раз спрашиваю, кто вчера дрочил?'
    v 'Дункан, ты дрочил?'
    du 'Нет, сэр!'
    ##slaves scene 2
    v 'Так, Эрик, твоя очередь, ты дрочил вчера?'
    er 'Нет, сэр!'
    v 'Не ври мне! Я видел, как ты дрочишь.'
    er 'Сэр, на не нравится, как вы разговариваете с нами.'
    v 'Заткнись, чёртов раб! Мне насрать на то, что вам не нравится!'
    g 'Взять его, парни!'
    ##slaves scene 3
    g 'Парни, держите его!'
    er 'Бей его, Галтон!'
    ...
    v 'АААААА'
    d 'Да! Устроим бунт!'
    v 'Чёртовы рабы! Я ваш Мастер!'
    g '(бьет Вана)'
    v 'АААААА'
    d 'Парни, привязывайте его, накажем его за всё, что он сделал!'
    ##slaves scene 4
    v 'Идите нахуй! Чертовы рабы!'
    g 'Мы накажем тебя...'
    ##van sitting
    v 'Все рабы ушли из подземелья, а всё из-за того, что я хотел научить их не обманывать людей, не обманывать Мастера. Я не хотел причинить им вреда...'
    v 'Шли дни, недели, вот уже месяц я сидел один. Мне нужно было отомстить Марку Пульфу, но его было не найти.'
    v 'Рабы так и не вернулись...'
    v 'Я всё так же сижу один в этом подземелье... Это конец моей истории...'
    ''
    pause 2
    'Концовка одиночества.'
    return